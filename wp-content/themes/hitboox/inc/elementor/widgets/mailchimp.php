...
if (!hitboox_is_mailchimp_activated()) {
    return;
}
...
class Hitboox_Elementor_Mailchimp extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'hitboox-mailchimp';
    }

    public function get_title()
    {
        return esc_html__('MailChimp Sign-Up Form', 'hitboox');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .form-style .mc4wp-form .mc4wp-form-fields input[type="email"]',
            ]
        );
        ...
        $this->add_control(
            'input_color_border',
            [
                'label' => esc_html__('Color Border', 'hitboox'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .form-style .mc4wp-form .mc4wp-form-fields button[type=submit]',
            ]
        );
        ...
        $this->add_control(
            'button_icon_hover',
            [
                'label' => esc_html__('Icon Color hover', 'hitboox'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Icon Border Color hover', 'hitboox'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
    ...
    {
        echo '<div class="form-style path-wrap-yes">';
            mc4wp_show_form();
        echo '</div>';
    }
}

$widgets_manager->register(new Hitboox_Elementor_Mailchimp());
