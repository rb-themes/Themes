...
if ( ! function_exists( 'hitboox_elementor_parse_text_editor' ) ) {
	function hitboox_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'hitboox_elementor_get_strftime' ) ) {
	function hitboox_elementor_get_strftime( $instance, $obj ) {
		$string = '';
