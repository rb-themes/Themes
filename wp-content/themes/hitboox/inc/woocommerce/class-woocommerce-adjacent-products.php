<?php
/**
 * Hitboox WooCommerce Adjacent Products Class
 *
 * @package  hitboox
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Hitboox_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Hitboox WooCommerce Adjacent Products Class
	 */
	class Hitboox_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'hitboox_woocommerce_adjacent_query_args', $args ) );
