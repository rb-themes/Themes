...
// Temporarily disabled - uncomment after verifying widget file loads correctly
/*
function hitboox_register_custom_scrolling_widget($widgets_manager) {
    $widget_file = get_theme_file_path('inc/elementor/widgets/hitboox-slide-scrolling-custom.php');
...
add_action('elementor/widgets/register', 'hitboox_register_custom_scrolling_widget');
*/
